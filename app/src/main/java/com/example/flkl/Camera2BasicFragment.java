...
//                    imageMat=new Mat();
    ...
    private FaceClf faceClf;
    private boolean listAssetFiles(String path,ArrayList<String> out) {
        ...
        try {
            ...
            if (list.length > 0) {
                ...
                for (String file : list) {
                    if (!listAssetFiles(path + "/" + file,out))
                        return false;
                    else {
                        // This is a file
    ...
    private Bitmap RotateImage(Bitmap bitmap,int degress) {
        ...
        bitmap = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(), matrix, true); // rotating bitmapmSensorOrientation
        return bitmap;
    }
    /**
...
//                        textPaint.setStrokeWidth(mTextureView.getHeight()*0.3f);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        faceClf = new FaceClf(getActivity().getAssets());
        InitFaceFactory();
